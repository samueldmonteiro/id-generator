...
import { traineeSubscription, TraineeSubscriptionResponse } from '@/src/actions/badge-subscription-action';
...
export default function InscricaoEstagiario() {
  ...
  const [result, setResult] = useState<TraineeSubscriptionResponse | null>(null);
            ...
            <div className="text-center space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                  Seu cadastro para o crachá de estagiário foi realizado com sucesso.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    <strong>Importante:</strong> A foto será recortada no formato 4x4.
                    Use uma foto recente com fundo neutro.
                  </p>
                </div>
